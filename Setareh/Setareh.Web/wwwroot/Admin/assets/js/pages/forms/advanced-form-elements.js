...
function initImageSelect() {
	/* select with image */
	$('#imgsel').formSelect();
	var data = [{ id: 1, name: "Option 1", url: "../..//Admin//Site/assetsimages/user/user1.jpg" }, { id: 2, name: "Option 2", url: "../..//Admin//Site/assetsimages/user/user2.jpg" }, { id: 3, name: "Option 3", url: "../..//Admin//Site/assetsimages/user/user3.jpg" }];
