...
namespace Setareh.DAL.Migrations
{
    ...
    [Migration("20240621074239_AddActivityTable")]
            ...
            modelBuilder.Entity("Setareh.DAL.Entities.AboutMe.AboutMe", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2024, 6, 21, 11, 12, 36, 458, DateTimeKind.Local).AddTicks(9076),
                            Description = "",
                            Email = "",
                            FirstName = "",
                            ImageName = "",
            ...
            modelBuilder.Entity("Setareh.DAL.Entities.ContacUs.ContactUs", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Answer = "ندارد",
                            CreateDate = new DateTime(2024, 6, 21, 11, 12, 36, 458, DateTimeKind.Local).AddTicks(9032),
            ...
            modelBuilder.Entity("Setareh.DAL.Entities.User.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2024, 6, 21, 11, 12, 36, 458, DateTimeKind.Local).AddTicks(8855),
                            Email = "mahdiamiridev@gmail.com",
                            FirstName = "مهدی",
                            IsActive = true,
                            LastName = "امیری",
